module statistics
{
  ...
  proc statistics_all_locales_init_explored_tree(ref tree_each_locale: [] uint(64))
  {
    ...
    forall a in tree_each_locale do a = 0:uint(64);
  }

  proc statistics_tree_statistics(ref tree_each_locale: [] uint(64), const tree_size: uint(64))
  {
    var local_tree_each_locale: [0..#numLocales] uint(64);
    ...
    forall (a,b) in zip(local_tree_each_locale, tree_each_locale) do a = b;

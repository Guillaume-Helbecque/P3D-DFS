...
# Configuration of the Chapel's environment for distributed experiments on the
# Aion cluster of the Université du Luxembourg. Computer nodes are interconnected
# through a Fast InfiniBand (IB) HDR100 network.

module Header_chpl_c_QAP
{
	...
	extern "bound_RLT1_wrapper" proc bound_RLT1(const mapping: c_ptrConst(c_int), const available: c_ptrConst(c_int),
		depth: c_int, const F: c_ptrConst(c_int), const D: c_ptrConst(c_int), n: c_int, N: c_int, rlt_itmax: c_int,
		rlt_tol: c_double, best: c_ptr(int(64)), opt_solution: c_ptr(c_int), const warm: c_ptrConst(RLT_WarmData_wrapper),
